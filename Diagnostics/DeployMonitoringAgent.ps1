...
$deploymentName = 'MonitoringAgent'
$templateFile = 'C:\Projects\Azure\ServiceFabric\IoTDemo\Diagnostics\DeployMonitoringAgent.json'
$templateParameterFile = 'C:\Projects\Azure\ServiceFabric\IoTDemo\Diagnostics\DeployMonitoringAgentParams.json'
